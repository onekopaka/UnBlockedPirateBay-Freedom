...
function remove_bloat($toremove){
	...
	// Add rel=nofollow, and proxify some.
...
function remove_bloat_after_proxify($toremove){
	require("configurationfile.php");
	// This will make the result and footer substitutions work.
	$toremove = str_replace("<div id=\"main-content\">","<div id=\"main-content\">$codetop", $toremove);
	$toremove = str_replace("<p id=\"footer\" style=\"color:#666; font-size:0.9em; \">", "<p id=\"footer\" style=\"color:#666; font-size:0.9em;\">$footer", $toremove);
	return $toremove;
}
?>